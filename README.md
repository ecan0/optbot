...
> **Archived academic project:** Data collection is closed. The public site remains online as a read-only demonstration. Read the [archive record](docs/archive.md) and access the [final paper](publications/README.md).
